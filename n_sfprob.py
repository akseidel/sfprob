...
def login_the_session(driver_session):
    ...
    l_driver_session.get(santa_fe_county_url)
    ...
    text_box_user = l_driver_session.find_element(by=By.ID, value="txtUser")
    text_box_pwrd = l_driver_session.find_element(by=By.ID, value="txtPwd")
    login_button = l_driver_session.find_element(by=By.ID, value="btnLogin")
    # Filling in and pressing login
    print('Now attempting to login as public.')
    text_box_user.clear()
    text_box_user.send_keys("public")
    text_box_pwrd.clear()
    text_box_pwrd.send_keys("public")
    login_button.click()
